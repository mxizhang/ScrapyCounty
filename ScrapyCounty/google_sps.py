...
def morrisentry(sh, zillow_data, number):
...
def essexentry(sh, zillow_data, number):
	worksheet = sh.get_worksheet(number)
...
def bergenentry(sh, zillow_data, number):
	worksheet = sh.get_worksheet(number)
...
def choose(num):
	...
	if num == 0:
		print "0 -> morris"
		morrisentry(sh, zillow_data, 0)
	elif num == 1:
		print "1 -> essex"
		essexentry(sh, zillow_data, 1)
	elif num == 2:
		print "2 -> bergen"
		bergenentry(sh, zillow_data, 2)